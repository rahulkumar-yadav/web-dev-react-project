...
const Navgation = () => {
  return (
    <div className="flex items-center mt-[72px]">
      ...
      <p className="text-[#696671] text-center text-[18px] font-medium">
        Flashcard
      </p>
      <div>
        <svg
      ...
      <p className="text-[#06286E] text-center text-[18px] font-semibold">
        Relationa and Functions
      </p>
    </div>
  );
};
